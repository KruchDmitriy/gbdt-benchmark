...
| median time-per-iter, sec|     abalone     |     airline     |     epsilon     |      higgs      |     letters     |      msrank      |msrank-classification|    synthetic    | synthetic-5k-features |
|--------------------------|-----------------|-----------------|-----------------|-----------------|-----------------|------------------|---------------------|-----------------|-----------------------|
|catboost                  | 0.005 +/- 0.004 |  7.08 +/- 2.684 | 0.271 +/- 0.015 | 0.723 +/- 0.032 | 0.265 +/- 0.011 | 0.092 +/- 0.004  |   0.565 +/- 0.02    | 0.541 +/- 0.079 |   0.166 +/- 0.011     |
|xgboost                   |  0.01 +/- 0.001 | 6.293 +/- 0.378 | 9.008 +/- 0.456 |  0.75 +/- 0.192 | 0.125 +/- 0.025 | 0.256 +/- 0.09   |   1.701 +/- 0.198   | 1.199 +/- 0.23  |  12.481 +/- 3.716     |
|lightgbm                  |           0.002 | 5.002 +/- 0.375 | 1.344 +/- 0.185 | 0.691 +/- 0.254 |  0.074 +/- 0.02 | 0.131 +/- 0.027  |    0.95 +/- 0.284   | 1.097 +/- 0.242 |   1.1 +/- 0.213       |

CPU total training time 1000 iterations:

| total, sec | abalone | airline | epsilon | higgs  | letters | msrank | msrank-classification | synthetic | synthetic-5k-features |
|------------|---------|---------|---------|--------|---------|--------|-----------------------|-----------|-----------------------|
| catboost   |   6.57  | 974.107 |  266.77 | 733.27 |  259.75 | 89.72  |         55.349        |  593.87   |         166.57        |
| xgboost    |  13.70  | 611.934 | 8935.36 | 804.18 |  176.82 | 341.99 |        174.726        |  1327.40  |        14951.47       |
| lightgbm   |   6.43  | 526.182 | 1323.40 | 788.64 |  112.74 | 185.26 |         92.670        |  1154.13  |         1135.94       |

GPU time per iteration:

| median time-per-iter, sec |    abalone    |    airline    |    epsilon    |     higgs     |    letters    |     msrank    | msrank-classification |   synthetic   | synthetic-5k-features |
|---------------------------|---------------|---------------|---------------|---------------|---------------|---------------|-----------------------|---------------|-----------------------|
|          catboost         | 0.006 ± 0.001 | 0.486 ± 0.016 | 0.045 ± 0.005 | 0.056 ± 0.001 |     0.009     | 0.011 ± 0.001 |     0.022 ± 0.001     | 0.035 ± 0.003 |     0.027 ± 0.002     |
|          xgboost          | 0.005 ± 0.001 | 0.932 ± 0.094 | 2.686 ± 0.283 | 0.111 ± 0.019 | 0.034 ± 0.008 | 0.039 ± 0.006 |     0.366 ± 0.021     | 0.209 ± 0.022 |     1.357 ± 0.149     |
|          lightgbm         | 0.004 ± 0.016 | 3.641 ± 0.612 | 0.659 ± 0.107 |  0.166 ± 0.06 | 0.349 ± 0.099 | 0.053 ± 0.013 |     0.191 ± 2.961     |  0.112 ± 0.03 |      1.51 ± 0.148     |

GPU total training time 1000 iterations:

| total, sec | abalone | airline  | epsilon  |  higgs  | letters | msrank | msrank-classification | synthetic | synthetic-5k-features |
|------------|---------|----------|----------|---------|---------|--------|-----------------------|-----------|-----------------------|
|  catboost  |  5.763  | 485.825  |  44.971  |  55.601 |  9.271  | 11.057 |         22.156        |   36.658  |         28.014        |
|  xgboost   |  5.764  |  928.99  | 2661.741 | 110.485 |  36.79  | 40.003 |        372.541        |  210.305  |        1353.212       |
|  lightgbm  |  23.109 | 3716.344 |  686.4   | 166.228 | 115.383 | 60.688 |        204.634        |  123.255  |        1557.471       |
